...
<ul>
 <li><a href="adminDash.php">Manage Routes</a></li>
    ...
    <li><a href="BookingManage.php">Booked People</a></li>
     ...
     $cost=$_POST['cost'];
       if($conn->connect_error)
          ...
          else
          {
              ...
              $stmt=$conn->prepare("INSERT INTO route(source,destination,bus_name,departure_date,departure_time,cost) VALUES(?,?,?,?,?,?)");
              //table3 is the table name//
              $stmt->bind_param("sssssi",$source,$destination,$bus_name,$dep_date, $dep_time,$cost);
              $stmt->execute();
    ...
    <form action="#" method="POST">
      <div class="form_wrap">
        <div class="input_wrap">
          ...
          <input type="text" id="title" name="source" placeholder="source" required>
        </div>
        <div class="input_wrap">
